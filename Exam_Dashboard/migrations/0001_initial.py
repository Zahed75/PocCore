# Generated by Django 3.2.9 on 2022-01-18 11:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marks', models.IntegerField(blank=True, default=4, null=True)),
                ('exam_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='name_of_examThree_sub', to='Exam_Dashboard.createexam')),
                ('main_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_question', to='Exam_Dashboard.questionmodel_three')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='AnsModel_Three_Sub',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ans', models.CharField(max_length=400)),
                ('is_correct', models.BooleanField(default=False)),
                ('Question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_three_sub', to='Exam_Dashboard.questionmodel_three_sub')),
            ],
        ),
        migrations.CreateModel(
            name='AnsModel_Three',
